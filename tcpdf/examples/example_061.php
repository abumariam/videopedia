...
$pdf->SetAuthor('Abdel-Kawy Abdel-Hady');
$pdf->SetTitle('Arab Open University');
$pdf->SetSubject('Export PDF');
$pdf->SetKeywords('TCPDF, PDF, example, test, guide');

// set default header data
$pdf->SetHeaderData('vca-logo.jpg', 30, 'Course Name', 'Course Syllabus');
...
$str = "<ol>";
for($i=1;$i<30;$i++){
$str .= "<li>Abdel-Kawy Test Text. [ $i ] </li>";
}
$str .="</ol>";
$html = <<<EOF
...
<p id="second">Example of paragraph with ID selector. <span>$str</span></p>
EOF;
